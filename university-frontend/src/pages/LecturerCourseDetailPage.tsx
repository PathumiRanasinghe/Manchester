      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl p-0 overflow-hidden">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-2/5 w-full h-70 md:h-auto relative m-8">
            <img src="/lecturercourse.png" alt="Course" className="object-cover w-full h-full rounded-2xl" />
          </div>
          <div className="md:w-3/5 w-full p-8 flex flex-col justify-center">
            ...
            <div className="flex gap-4 mt-4 text-s">
              <span className="bg-blue-100 text-blue-500 px-3 py-1 rounded-full font-semibold">Credits: {module.credits}</span>
            </div>
          </div>
        </div>
        <div className="border-b mt-3 px-8 flex gap-6 text-blue-500 text-sm font-semibold">
